const goodHead = require(__dirname + '/good-head');
...
var Router = module.exports = exports = function() {
  this.routes = {
    ...
    'FourOhFour': function(req, res) {
      goodHead(res, 404, 'plain/text', 'Page not found');
    }
  };
};
...
// Router.prototype.fourOhFour = function(url, callback) {
//   this.routes['FourOhFour'][url] = callback;
// };
